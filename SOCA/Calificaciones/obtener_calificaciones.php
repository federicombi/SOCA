<?php
    ...
    function obtenerEstados(){
        ...
        global $minimo_aprobado, $minimo_promocion, $minimo_percent, $calificaciones_obtenidas,$alumnos, $porcentajes_de_asistencias, $calificaciones;
    ...
    function obtenerTiposDeCalificacionesIngresadas($id_curso){
        ...
        array_push($tipos_de_calificacion, ["tipo"=>"promedio"]);
    ...
    function sacarPromedio($notas_que_promedian_un_alumno){
        ...
        try{
            $promedio_sin_redondear = $promedio;
            $promedio = round($promedio_sin_redondear, 1);
        }finally{
            return $promedio;
        }
